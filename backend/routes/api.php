    ...
    */
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::patch('/students/{id}/lrn', [StudentController::class, 'updateLrn']);
        
        // Standard student endpoints (parameterized)
        Route::get('/students', [StudentController::class, 'index']);
        Route::post('/students', [StudentController::class, 'store']);          // manual add (if needed)
        Route::put('/students/{id}', [StudentController::class, 'update']);    // if you have update
