...
const PaymentReports = () => {
    ...
    // Shared fetch function that respects a signal object for cancellation
    const fetchPayments = useCallback(async (signal = { cancelled: false }) => {
        try {
            setLoading(true);
            ...
            if (!signal.cancelled) console.error('Error fetching payments:', err);
        } finally {
            ...
            <div className="reports-container">
                <div className="reports-header">
                    ...
                    <div className="reports-actions">
                        ...
                        <button onClick={() => fetchPayments({ cancelled: false })} className="btn-refresh">
                            <FaSync /> Refresh
                        </button>
                    </div>
                </div>
