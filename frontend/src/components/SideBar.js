    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-menu">
        ...
        <Link
          to="/admin/enroll"
          className={
            location.pathname.includes("/admin/enroll") ? "active" : ""
          }
        >
          <FaUserPlus />
        ...
        {(user?.role === "admin" || user?.role === "registrar") && (
          <Link
            ...
            className={
              location.pathname.includes("/enrollment-management")
                ? "active"
                : ""
            }
          >
        ...
        <Link
          ...
          className={
            location.pathname.includes("/enrolled-students") ? "active" : ""
          }
        >
          <FaUserGraduate />
        ...
        <Link
          ...
          className={
            location.pathname.includes("/section-management") ? "active" : ""
          }
        >
        ...
        <Link
          ...
          className={
            location.pathname.includes("/subject-management") ? "active" : ""
          }
        >
        ...
        {(user?.role === "admin" || user?.role === "registrar") && (
          <Link
            to="/admin/evaluation"
            className={
              location.pathname.includes("/admin/evaluation") ? "active" : ""
            }
          >
            <FaBook />
        ...
        <Link
          to="/payment-reports"
          className={
            location.pathname.includes("/payment-reports") ? "active" : ""
          }
        >
          <FaFileInvoiceDollar />
